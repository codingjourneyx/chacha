...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-950 via-indigo-950 to-black text-white pt-20 pb-10 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full bg-blue-600/10 blur-[120px]"></div>
      
      {/* Newsletter Section - Before Grid */}
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <div className="bg-gradient-to-r from-indigo-600/20 via-purple-600/20 to-indigo-600/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm border border-white/5 shadow-xl">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <form onSubmit={handleSubmit} className="w-full md:w-auto flex flex-col sm:flex-row gap-3">
              <input 
                ...
                className="px-4 py-3 bg-white/10 backdrop-blur-md border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400 text-white placeholder:text-white/60 w-full md:w-64"
                required
              />
              <button 
                type="submit" 
                className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-xl shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 transition-all duration-300 hover:scale-105 whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="flex space-x-3 pt-4">
              ...
              <a href="#" className="group">
                <div className="w-10 h-10 rounded-lg bg-white/10 hover:bg-indigo-500 flex items-center justify-center backdrop-blur-sm border border-white/5 transition-all duration-300 group-hover:scale-110">
                  <svg className="w-5 h-5 text-indigo-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="md:col-span-2 space-y-5">
            <h3 className="text-lg font-semibold relative inline-block mb-4">
              ...
              <span className="absolute -bottom-1 left-0 w-12 h-0.5 bg-gradient-to-r from-indigo-400 to-purple-500"></span>
            </h3>
          ...
          <div className="md:col-span-3 space-y-5">
            ...
            <div className="space-y-4">
              <a href="#map" className="flex items-center text-slate-300 group hover:text-white transition-colors">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-indigo-500/10 backdrop-blur-md flex items-center justify-center border border-indigo-500/20 mr-3 group-hover:bg-indigo-500/20 transition-colors">
